...
if check1:
    ...
    st.text('Pasos equilibrados 50')
    epochs=st.slider('Pasos',1,300,key='3')
...
if check2:
    ...
    st.text('Pasos equilibrados 150')
    epochs2=st.slider('Pasos',50,500,key='8')
...
if check3:
    ...
    st.text('Pasos equilibrados 150')
    epochs3=st.slider('Pasos',50,500,key='13')
